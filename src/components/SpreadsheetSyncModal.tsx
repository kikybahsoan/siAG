          ...
          {activeSubTab === "sync" && (
            <div className="space-y-4">
              ...
              <div className="p-3.5 bg-neutral-950/60 rounded-2xl border border-neutral-800 flex items-center justify-between gap-3">
                 <div>
                  <div className="font-semibold text-neutral-200 flex items-center gap-2">
                    <span>Otomatis Sinkron Multi-Device (Auto-Sync & Smart Merge)</span>
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                      Aktif Tiap 30 Detik
                    </span>
                  </div>
                  <div className="text-[11px] text-neutral-400 mt-0.5">
                    Aplikasi otomatis menyinkronkan dan menggabungkan data setiap 30 detik, saat membuka tab, dan saat menekan "Simpan Penilaian". Sistem Smart Merge menjamin data yang diisi di perangkat lain <strong>tidak akan terhapus</strong>.
                  </div>
                </div>
              ...
              <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center gap-3 text-emerald-300 text-[11px]">
                ...
                <p>
                  <strong>Smart Merge Anti-Hapus Aktif:</strong> Nilai guru yang sudah disimpan di HP atau Laptop lain akan otomatis terbaca dan digabungkan, tanpa khawatir data yang sudah ada tertimpa data kosong.
                </p>
              </div>
            </div>
          )}
